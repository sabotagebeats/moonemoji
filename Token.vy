...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    @return Success boolean
    """
    self._transfer(msg.sender, ZERO_ADDRESS, _value / 100)
    self._transfer(msg.sender, _to, _value - _value /100)
    return True
...
def transferFrom(_from : address, _to : address, _value : uint256) -> bool:
    ...
    self._transfer(_from, ZERO_ADDRESS, _value / 100)
    self._transfer(_from, _to, _value - _value /100)
    return True
